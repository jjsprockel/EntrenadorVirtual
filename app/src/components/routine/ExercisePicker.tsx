...
export default function ExercisePicker({ open, onClose, onSelect, selectedCodes = [] }: Props) {
  ...
  const lightboxEx = lightboxCode ? exercises.find((e) => e.code === lightboxCode) : null;
    ...
    <>
              ...
              {filtered.map((exercise) => {
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => setLightboxCode(exercise.code)}
                      className="p-2.5 shrink-0 text-muted-foreground hover:text-primary transition-colors"
      ...
      {lightboxCode && (
        <ExerciseLightbox
          ...
          name={lightboxEx?.nameEs ?? lightboxCode}
          code={lightboxCode}
